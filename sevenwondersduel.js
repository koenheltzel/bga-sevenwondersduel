        ...
        return declare("bgagame.sevenwondersduelagora", ebg.core.gamegui, {
            ...
            */
            ...
            getConspiracyDivHtml: function (conspiracyId, spriteId, full=false, position=-1, prepared=0, triggered=0) {
                ...
                data.jsPeekDisplay = conspiracyId <= 16 ? 'inline-block' : 'none';
            ...
            onPlayerTurnTriggerConspiracyClick: function (e) {
                ...
                if (this.isCurrentPlayerActive()) {
                    ...
                    this.ajaxcall("/sevenwondersduelagora/sevenwondersduelagora/actionTriggerConspiracy.html", {
                            lock: true,
                ...
                if (this.isCurrentPlayerActive()) {
                    switch (e.target.id) {
                        ...
                        case "buttonPlaceInfluence":
                            ...
                            this.ajaxcall("/sevenwondersduelagora/sevenwondersduelagora/actionChooseConspiratorActionPlaceInfluence.html", {
                                    lock: true
                                },
                                this, function (result) {
                                    // What to do after the server call if it succeeded
