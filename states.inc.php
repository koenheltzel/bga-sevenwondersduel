...
$machinestates = [
    ...
    SevenWondersDuel::STATE_CHOOSE_OPPONENT_BUILDING_ID => [
        ...
        "description" => clienttranslate('${actplayer} must choose one of the opponent\'s ${buildingType} buildings to discard'),
        "descriptionmyturn" => clienttranslate('${you} must choose one of the opponent\'s ${buildingType} buildings to discard'),
        "type" => "activeplayer",
