...
class Player extends Base{
    ...
    public static function getStartPlayer() {
        return self::get(SevenWondersDuel::get()->getGameStartPlayerId());
    }
    ...
    public function getAstarteCoins() {
        if (self::hasDivinity(4)) {
            return (int)SevenWondersDuel::get()->getGameStateValue(SevenWondersDuel::VALUE_ASTARTE_COINS);
        }
        return 0;
    }
    ...
    public function increaseCoins($increase) {
        if ($increase < 0) {
            ...
            if ($originalIncrease != $increase && $astarteCoins > 0) {
                ...
                SevenWondersDuel::get()->setGameStateValue(SevenWondersDuel::VALUE_ASTARTE_COINS, $astarteCoins + $astarteIncrease);
        ...
        if ($increase != 0) {
            ...
            switch (strtolower($category)) { // strtolower to be sure but shouldn't be necessary anymore.
                ...
                case strtolower(Building::TYPE_PURPLE):
                    ...
                    break;
                case SevenWondersDuel::SCORE_DIVINITIES:
                    SevenWondersDuel::get()->incStat($increase, SevenWondersDuel::STAT_VP_DIVINITIES, $this->id);
                    break;
    ...
    public function getScoreCategories() {
        ...
        $pantheon_column = SevenWondersDuel::get()->getGameStateValue(SevenWondersDuel::OPTION_PANTHEON) ? ',`player_score_divinities`' : '';
    ...
    public static function snakeTokenBuilding() : ?Building {
        $building = Building::get((int)SevenWondersDuel::get()->getGameStateValue(SevenWondersDuel::VALUE_SNAKE_TOKEN_BUILDING_ID));
        return $building;
    }
