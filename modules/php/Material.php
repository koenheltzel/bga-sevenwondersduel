...
class Material extends Base
{
    ...
    private function initialize() {
        ...
        $this->wonders[5] = (new Wonder(5, clienttranslate("The Mausoleum")))
            ...
            ->addActionState(SevenWondersDuel::STATE_CHOOSE_DISCARDED_BUILDING_NAME)
            ->setVictoryPoints(2);
        ...
        $this->wonders[16] = (new Wonder(16, clienttranslate("The Divine Theater")))
            ...
            ->addActionState(SevenWondersDuel::STATE_CHOOSE_DIVINITY_DECK_NAME)
        ...
        $this->divinities[1] = (new Divinity(1, clienttranslate("Enki"), Divinity::TYPE_GREEN))
            ...
            ->addActionState(SevenWondersDuel::STATE_CHOOSE_ENKI_PROGRESS_TOKEN_NAME);
        ...
        $this->divinities[3] = (new Divinity(3, clienttranslate("Nisaba"), Divinity::TYPE_GREEN))
            ...
            ->addActionState(SevenWondersDuel::STATE_PLACE_SNAKE_TOKEN_NAME);
        ...
        $this->divinities[9] = (new Divinity(9, clienttranslate("Zeus"), Divinity::TYPE_BLUE))
            ...
            ->addActionState(SevenWondersDuel::STATE_DISCARD_AGE_CARD_NAME);
        ...
        $this->divinities[10] = (new Divinity(10, clienttranslate("Anubis"), Divinity::TYPE_GREY))
            ...
            ->addActionState(SevenWondersDuel::STATE_DECONSTRUCT_WONDER_NAME);
        ...
        $this->divinities[11] = (new Divinity(11, clienttranslate("Isis"), Divinity::TYPE_GREY))
            ...
            ->addActionState(SevenWondersDuel::STATE_CONSTRUCT_WONDER_WITH_DISCARDED_BUILDING_NAME);
        ...
        $this->divinities[14] = (new Divinity(14, clienttranslate("Minerva"), Divinity::TYPE_RED))
            ...
            ->addActionState(SevenWondersDuel::STATE_PLACE_MINERVA_TOKEN_NAME);
        ...
        $this->divinities[15] = (new Divinity(15, clienttranslate("Neptune"), Divinity::TYPE_RED))
            ...
            ->addActionState(SevenWondersDuel::STATE_DISCARD_MILITARY_TOKEN_NAME)
            ->addActionState(SevenWondersDuel::STATE_APPLY_MILITARY_TOKEN_NAME);
        ...
        $this->divinities[16] = (new Divinity(16, clienttranslate("Gate"), Divinity::TYPE_GATE))
            ...
            ->addActionState(SevenWondersDuel::STATE_CHOOSE_DIVINITY_FROM_TOP_CARDS_NAME);
